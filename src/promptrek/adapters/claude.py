        ...
        for agent_file in agents_dir.glob("*.md"):
            try:
                ...
                if frontmatter:
                    ...
                    # Parse markdown format (generated by _build_agent_content)
                    ...
                    # Extract system prompt (after ## System Prompt)
                    ...
                    if config_match:
                        ...
                        approval_match = re.search(r'Requires Approval:\s*(True|False)', config_text)
                        if approval_match:
        ...
        for command_file in commands_dir.glob("*.md"):
            try:
                ...
                if frontmatter:
                    ...
                    # Extract name from # heading
                    name_match = re.match(r'^#\s+(.+?)$', content, re.MULTILINE)
                    name = name_match.group(1).strip() if name_match else command_file.stem
